...
//
// ???????????????????????????????????????????????????????????????????? Не можу витягнути значення кожної характеристики об'єкта. А для властивості modules зробити список з елементами теж не знаю як.
...
for (const coursesArrayElement of coursesArray) {
    ...
    for (const coursesArrayElementSub in coursesArrayElement) {
        ...
        divForElement.appendChild(subDiv);
        subDiv.innerHTML = `${coursesArrayElementSub}`;
    }
}
...
// let copiedDiv = div.cloneNode(true);
// document.body.appendChild(copiedDiv);



// ,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,Для цього завдання створював окремий HTML-файл index.template1.html
// - Є масив:
...
//     liCreate.innerText = string;
//     ulFind.appendChild(liCreate);
// }
